    ...
    <form method="post" action="final">
      <div class="row">
        ...
        <div class="input-field col s6">
          ...
          <input id="icon_prefix" type="text" value='<?= $country; ?>' name="country" class="validate" required>
        ...
        <div class="center-align">
          <button type="submit" id="confirmed" name="pay" class="btn meh button-rounded waves-effect waves-light ">Place Order</button>
        </div>
      </div>
    </form>
  </div>
