  ...
  <div class="row">
    ...
    <div class="col s12 m2 center-align cat">
      <div class="collection card">
        ...
        ?>
            <a href="category.php?id=<?= $id_categorydb; ?>" class='collection-item <?php if ($id_categorydb == $id_category) {
                                                                                      echo "active";
                                                                                    } ?>'><?= $name_category; ?></a>
        <?php }
        } ?>
    ...
    <div class="col s12 m10 ">
      <div class="container-fluid content">
        ...
        <div class="row">
          ...
          $queryproduct = "SELECT * FROM product WHERE id_category = '{$id_category}' ORDER BY id DESC LIMIT {$start}, 16";
          ...
          ?>
              ...
              <div class="col s12 m4">
                <div class="card hoverable animated slideInUp wow product">
                  <div class="card-image">
                    <a href="product.php?id=<?= $id_product; ?>">
                      <img src="products/<?= $thumbnail_product; ?>"></a>
                    <span class="card-title"><?= $name_product; ?></span>
                  ...
                  <div class="card-action">
                    <div class="space-between">
                      <span class="white-text"><i class="fa fa-dollar"></i> <?= $price_product; ?></span>
                      <span class="white-text text-right"><i class="fa fa-shopping-basket"></i> <?= $stock; ?></span>
                    </div>
                  </div>
                </div>
              </div>
