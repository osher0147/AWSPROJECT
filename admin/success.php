...
if (isset($_POST['done'])) {
  ...
  $img_pathpic1 = "../products/" . $_FILES["picture1"]["name"];
...
VALUES ('$picture1', '$idproduct')";
  ...
  //adding product
  $queryaddproduct = "INSERT INTO product(id_category, name, description, price, thumbnail, stock)
  VALUES ('$id_category', '$name', '$description','$price', '$picture1', $quantity)";
