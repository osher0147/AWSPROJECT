  ...
  <form method="post" enctype="multipart/form-data">
    <div class="card">
      ...
      <div class="center-align">
        <img class="responsive-img" style="height: 175px !important" src="src/img/<?= $caticon; ?>.png">
      </div>
      ...
      <div class="row">
        ...
        <div class="input-field col s12">
          <i class="prefix fa fa-sort-numeric-asc"></i>
          <input id="icon_prefix" type="number" class="validate" name="quantity" value="1">
        ...
        <div class="file-field input-field col s2">
          <div class="red btn">
            <span>Picture</span>
            <input type="file" name="picture1" accept=".png,.jpeg,.jpg">
          </div>
          <div class="file-path-wrapper">
