  ...
  <div class="container current-page">
    <nav>
      <div class="nav-wrapper">
        <div class="col s12">
          <a href="../index" class="breadcrumb">MyShop</a>
      ...
      <div class="card horizontal">
        ...
        <div class="card-stacked">
          ...
          <div class="card-action">
            <a href="infoproduct" class="blue-text">Manage</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="col s12 m4">
      <div class="card horizontal">
        ...
        <div class="card-stacked">
          ...
          <div class="card-action">
            <a href="products" class="blue-text">Manage</a>
          </div>
        </div>
    ...
    <div class="col s12 m4">
      <div class="card horizontal">
        ...
        <div class="card-stacked">
          ...
          <div class="card-action">
            <a href="allusers" class="blue-text">Manage</a>
          </div>
        </div>
      </div>
    </div>
